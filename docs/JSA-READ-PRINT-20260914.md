...
Replacement candidate: vc39, source cc5c22268458b72850e7aace76eed0615a92342e, EAS c683addd-a214-46f1-940f-e3cbfd3b1059 (preview Android APK). Build/install and physical read/print verification remain pending. The local finish-jsa39.ps1 helper verifies source/version, downloads and hashes the APK, then installs only on connected phones without JSA in the foreground. Results are under C:/dev/output/dashboard-audit-20260912/jsa39-install-result.json when complete. No test JSA has been submitted to production and no driver acknowledgement was performed by automation. Dashboard/photo work, WB-T and WB-E were not edited.
