...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    "Your registration is waiting for approval.": "Su registro está esperando aprobación.",
    ...
    "Registration approved for": "Registro aprobado para",
    "Continue to App": "Continuar a la aplicación",
    "Access Denied": "Acceso denegado",
    "Your registration request was denied.": "Su solicitud de registro fue denegada.",
    "If you believe this is a mistake, contact an administrator.": "Si cree que esto es un error, contacte a un administrador.",
    "Start Over": "Empezar de nuevo",
    "New Employee Registration": "Registro de nuevo empleado",
    "Enter your info to register with your company": "Ingrese sus datos para registrarse con su empresa",
    "Enter your name and passcode to sign in": "Ingrese su nombre y código de acceso para iniciar sesión",
    "Display Name": "Nombre de usuario",
    "Your Name": "Su nombre",
    "Display name (e.g., MBurger)": "Nombre de usuario (p. ej., MBurger)",
    "Your name": "Su nombre",
    ...
    "Company Join Code": "Código de unión de la empresa",
    "Code from your employer": "Código proporcionado por su empleador",
    "Your employer provides this code": "Su empleador proporciona este código",
    ...
    "No company? Use JSA independently.": "¿Sin empresa? Use JSA de forma independiente.",
    "Register as Independent Driver": "Registrarse como conductor independiente",
