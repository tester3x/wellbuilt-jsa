...
interface BuildOptions {
  additions?: {location:string;operator:string;activity:string;hazards:string;controls:string;ppe:string;acknowledgedAtMs:number}[];
  driverName: string;
  truckNumber: string;
  pusher: string;
    ...
    <div class="section">
      ...
      ${sigImgSrc
        ...
        : `<div style="font-size:12px">
            <span style="font-weight:600;border-bottom:1px solid #ccc;padding-bottom:2px">${signature || ''}</span>
          </div>`}
    </div>
